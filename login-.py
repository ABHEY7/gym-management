...
class Login:
    ...
    def loginFrame(self):
     ...
     #title
        ...
        #buttons
        self.login_1=Button(self.root,text=("Sign in"),width=12,bg='blue',fg='white',font=("century",14,"bold"),command=self.submit)
        self.login_1.place(x=820,y=470,height="40")
        
        self.login_1=Button(self.root,text=("Sign out"),fg='blue',font=("century",6,"bold"),command=self.submit)
        self.login_1.place(x=940,y=410,height="14",width='50')
        
       
        self.login_1=Label(self.root,text=("Don't have any account ?"),width=22,bg='white',fg='black',font=("century",7,'bold'))
