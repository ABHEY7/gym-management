...
class Login:
    ...
    def loginFrame(self):
      ...
      #whiteframe
        ...
        Frame_login.place(x=700,y=100,height=570,width=490)
     ...
     #title
        ...
        title=Label(Frame_login,text="NEW ENTRY HERE",font=("impact",30,"bold"),fg="blue",bg="white")
        title.place(x=40,y=20)     
        title=Label(Frame_login,text=" GYM ENTRY AREA",font=("century",10,"bold"),fg="blue",bg="white")
        title.place(x=98,y=65) 
        #lables
        self.name=Label(Frame_login,text="NAME :- ",font=("century",11,"bold"),fg="black",bg="white")
        self.name.place(x=50,y=131,width=90,height=20)
        self.password=Label(Frame_login,text=" STARTING DATE:-",fg="black",bg="white",font=("century",11,"bold"))
        self.password.place(x=50,y=219,width=160,height=20)
        self.password=Label(Frame_login,text="CONTACT NO.:-",fg="black",bg="white",font=("century",11,"bold"))
        self.password.place(x=50,y=299,width=150,height=20)
        self.password=Label(Frame_login,text="ADRESS:-",fg="black",bg="white",font=("century",11,"bold"))
        self.password.place(x=30,y=380,width=150,height=20)

        #entrys 
        self.nam=Entry(Frame_login,width=50,bg='lightgrey')
        self.nam.place(x=50,y=158,height=35)
        self.passw=Entry(Frame_login,width=50,bg='lightgrey')
        self.passw.place(x=50,y=248,height=35)
        self.CONT=Entry(Frame_login,width=50,bg='lightgrey')
        self.CONT.place(x=50,y=328,height=35)
        self.adress=Entry(Frame_login,width=50,bg='lightgrey')
        self.adress.place(x=50,y=408,height=75)
        #buttons
        self.login_1=Button(self.root,text=("SUBMIT"),width=11,bg='blue',fg='white',font=("century",11,"bold"),command=self.Password)
        self.login_1.place(x=750,y=615,height="36")
        self.login_1=Button(self.root,text=("SHOW DETAIL"),width=15,bg='blue',fg='white',font=("century",11,"bold"),command=self.enter)
        self.login_1.place(x=900,y=615,height="36")
    ...
    def Password(self):
        ...
        data = (self.nam.get(),self.passw.get(),self.CONT.get(),self.adress.get())
        print(data)
        if self.nam.get() == '':
            messagebox.showinfo('Alert', 'Please enter an username.')
        elif self.passw.get() == '':
            messagebox.showinfo('Alert', 'Please enter the user starting date.')
        elif self.CONT.get() == '':
            messagebox.showinfo('Alert', 'Please enter enter the contact number.')
        elif self.adress.get() == '':
            messagebox.showinfo('Alert', 'enter the adress.')
        else:
